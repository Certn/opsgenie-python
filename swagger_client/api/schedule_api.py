...
class ScheduleApi(object):
    ...
    def get_schedule_timeline(self, identifier, **kwargs):  # noqa: E501
        ...
        :param datetime _date: Time to return future date on-call participants. Default date is the moment of the time that request is received
    ...
    def get_schedule_timeline_with_http_info(self, identifier, **kwargs):  # noqa: E501
        ...
        all_params = ['identifier', 'identifier_type', 'expand', 'interval', 'interval_unit', '_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
