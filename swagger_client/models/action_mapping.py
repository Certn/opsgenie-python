...
class ActionMapping(object):
    ...
    def action(self, action):
        ...
        allowed_values = ["create", "acknowledge", "unacknowledge", "snooze", "escalate-to-next", "add-note", "add-responder", "add-tags", "remove-tags", "close", "delete", "escalate", "custom-action", "assign-ownership", "take-ownership", "update-priority", "update-description", "update-message"]  # noqa: E501
