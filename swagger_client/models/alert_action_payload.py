...
class AlertActionPayload(object):
    ...
    def __init__(self, user=None, note=None, source=None):  # noqa: E501
        """AlertActionPayload - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def user(self):
        """Gets the user of this AlertActionPayload.  # noqa: E501

        Display name of the request owner  # noqa: E501

        :return: The user of this AlertActionPayload.  # noqa: E501
        :rtype: str
        """
        return self._user
    ...
    @property
    def note(self):
        """Gets the note of this AlertActionPayload.  # noqa: E501

        Additional note that will be added while creating the alert  # noqa: E501

        :return: The note of this AlertActionPayload.  # noqa: E501
        :rtype: str
        """
        return self._note
    ...
    @property
    def source(self):
        """Gets the source of this AlertActionPayload.  # noqa: E501

        Source field of the alert. Default value is IP address of the incoming request  # noqa: E501

        :return: The source of this AlertActionPayload.  # noqa: E501
        :rtype: str
        """
        return self._source
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AlertActionPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertActionPayload):
            return False
